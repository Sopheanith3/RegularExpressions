...
- **Social Security Number (SSN)**  
  Supports multiple formats (with dashes, spaces, or no spaces) and ensures validity based on SSA numbering rules (**extra credit**).
- **US Phone Number**  
  Accepts numbers with optional parentheses and dashes, validating only official area codes (**extra credit**).
- **Email Address**  
...
- **City, State, ZIP Code**  
  Ensures proper formatting, with state abbreviation validation (**extra credit**).
- **Military Time**  
